...
#define PACKET_TYPE 0x02 // send 2 packet of telemetry fc > gs
...
void sendExtraTelemetry() {
  ...
  */
  ...
  31-32		  uint16	Apogee
  33-36     ...  
  37		    bin	    Stand State + Additional State	
  38-39		  uint16	V_BAT	mV			
  40-41		  uint16	CURR_BAT	mA				
  42-43		  uint16	load cell	g  
  */
